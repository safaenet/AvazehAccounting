...
public class TransactionsController : ControllerBase
{
    ...
    public async Task<ActionResult<ItemsCollection_DTO<TransactionSummaryDTO>>> GetItemsAsync(int Page = 1, string SearchText = "", string OrderBy = "Id", OrderType orderType = OrderType.DESC, int Id = 0, string Date = null, TransactionFinancialStatus? FinStatus = null, int PageSize = 50, bool ForceLoad = false)
    {
