...
AS
BEGIN
	DECLARE @Result DECIMAL = (SELECT dbo.GetDiscountedInvoiceSum(i.DiscountType, i.DiscountValue, ISNULL(sp.TotalSellValue, 0)) - ISNULL(pays.TotalPayments, 0) FROM Invoices i
