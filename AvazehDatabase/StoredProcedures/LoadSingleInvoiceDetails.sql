...
BEGIN
	...
	(
		...
		[CustomerId] [int],
		[About] [nvarchar] (50),
		[DateCreated] dbo.DateType,
		[TimeCreated] dbo.TimeType,
		[DateUpdated] dbo.DateType,
		[TimeUpdated] dbo.TimeType,
		[DiscountType] [tinyint],
		[DiscountValue] DECIMAL(18, 1),
		[Descriptions] [ntext],
		[LifeStatus] [tinyint],
		[PrevInvoiceId] [int],
		[PrevInvoiceBalance] dbo.CalculationType,
