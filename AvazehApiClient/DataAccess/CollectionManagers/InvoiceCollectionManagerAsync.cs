...
public class InvoiceCollectionManagerAsync : IInvoiceCollectionManager
{
    ...
    public ObservableCollection<InvoiceSummaryDTO> Items { get; set; }
    ...
    public InvoiceSummaryDTO GetItemFromCollectionById(int Id)
    {
    ...
    {
        var collection = await ApiProcessor.GetInvoiceCollectionAsync<List<InvoiceSummaryDTO>>(Key, PageSize, InvoiceIdToSearch, CustomerIdToSearch, InvoiceDateToSearch, SearchValue, LifeStatus, FinStatus, SearchMode, orderType, StartId);
    ...
    public async Task<ObservableCollection<InvoiceSummaryDTO>> LoadPrevInvoices(int InvoiceId, string InvoiceDate, string searchValue, OrderType orderType)
    {
        var collection = await ApiProcessor.GetInvoiceCollectionAsync<List<InvoiceSummaryDTO>>(Key + "/LoadPrevInvoices", InvoiceId: InvoiceId, InvoiceDate: InvoiceDate, SearchValue: searchValue, orderType: orderType);
