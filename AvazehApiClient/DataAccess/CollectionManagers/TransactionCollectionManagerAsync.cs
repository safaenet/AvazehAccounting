...
public class TransactionCollectionManagerAsync : ITransactionCollectionManager
{
    ...
    public ObservableCollection<TransactionSummaryDTO> Items { get; set; }
    ...
    public TransactionSummaryDTO GetItemFromCollectionById(int Id)
    {
    ...
    public async Task<int> GotoPageAsync(int PageNumber, bool Refresh = false)
    {
        ...
        var collection = await ApiProcessor.GetTransactionCollectionAsync<ItemsCollection_DTO<TransactionSummaryDTO>>(Key, QueryOrderBy, QueryOrderType, TransactionIdToSearch, TransactionDateToSearch, PageNumber, SearchValue, FinStatus, PageSize, Refresh);
