...
namespace AvazehApiClient.DataAccess
{
    public class AppSettingsManager : IAppSettingsManager
    {
        ...
        public async Task<InvoicePrintSettingsModel> LoadInvoicePrintSettings() => await Processor.GetItemAsync<InvoicePrintSettingsModel>($"{ Key }/{ nameof(AppSettingsModel.InvoicePrintSettings) }", null);
